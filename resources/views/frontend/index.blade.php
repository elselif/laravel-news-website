                                              ...
                                              <div class="secOne_newsContent">
                                                  <div class="sec-one-image">
                                                      ...
                                                      <h1 class="sec-one-title">
                                                          <a href=" ">India restricts rice exports, could
                                                              fuel food inflation</a>
                                                      </h1>
                                                  </div>
                                              </div>
                                          </div>
                              ...
                              <ul class="nav nav-pills" id="categori-tab" role="tablist">
                                  ...
                                  <li class="nav-item" role="presentation">
                                      <div class="nav-link" id="categori-tab2" data-bs-toggle="pill"
                                          data-bs-target="#Info-tabs2" role="tab"
                                          aria-controls="Info-tabs2" aria-selected="false">
                                          NATIONAL </div>
                                  </li>
                                  <li class="nav-item" role="presentation">
                                      <div class="nav-link" id="categori-tab3" data-bs-toggle="pill"
                                          data-bs-target="#Info-tabs3" role="tab"
                                          aria-controls="Info-tabs3" aria-selected="false">
                                          POLITICS
                                      </div>
                                  </li>
                                  <li class="nav-item" role="presentation">
                                      <div class="nav-link" id="categori-tab4" data-bs-toggle="pill"
                                          data-bs-target="#Info-tabs4" role="tab"
                                          aria-controls="Info-tabs4" aria-selected="false">
                                          SPORTS </div>
                                  </li>
                          ...
                          <div class="owl-stage-outer">
                              <div class="owl-stage"
                                  ...
                                  <div class="owl-item cloned active"
                                      style="width: 289.5px; margin-right: 10px;">
                                      <div class="secFour-wrpp ">
                                          <div class="secFour-image">
                                              <a href=" "><img class="lazyload"
                                                      src="assets/images/lazy.jpg"></a>
                      ...
                      <div class="homeGallery1 owl-carousel owl-loaded owl-drag">
                          ...
                          <div class="owl-stage-outer">
                              <div class="owl-stage"
                                  ...
                                  <div class="owl-item cloned active"
                                      style="width: 122.333px; margin-right: 10px;">
                                      <div class="item">
                                          <div class="phtot2">
                                              <a class="themeGallery" href="assets/images/6786.jpg">
                                                  <img src="assets/images/lazy.jpg" alt="PHOTO"></a>
