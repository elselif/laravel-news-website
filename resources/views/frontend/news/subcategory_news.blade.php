        ...
        <div class="row">
            <div class="col-lg-8 col-md-8">
                <div class="rachive-info-cats">
                    <a href=" "><i class="las la-home"></i> </a> <i class="las la-chevron-right"></i> {{$breadsubcat -> subcategory_name}}
                </div>
                <div class="row">
                                ...
                                <div class="archive-item-wrpp2">
                                    <div class="archive-shadow arch_margin">
                                        <div class="archive1_image2">
                                            <a href="{{url('news/details/'.$item->id.'/'.$item->news_title_slug)}} "><img class="lazyload" src="{{$newstwo->image}}"></a>
                                            <div class="archive1-meta">
                                                <a href=" "><i class="la la-tags"> </i>
                                                    {{$item->created_at->format('1 M d Y')}}}
                                                </a>
                                        ...
                                        <div class="archive1-padding">
                                            <div class="archive1-title2"><a href=" ">{{$item -> news_title}}</a>
                                                </a></div>
                                        </div>
                                    </div>
                                </div>
